...
val program: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Sast.expressao Ast.program)
...
module Incremental : sig
  ...
  val program: Lexing.position -> (Sast.expressao Ast.program) MenhirInterpreter.checkpoint
