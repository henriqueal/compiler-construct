...
| "until"       { ATE (pos_atual lexbuf)}
| "caso"      { CASO (pos_atual lexbuf)}
| "char" { CARACTER (pos_atual lexbuf)}
| "for"        { DE (pos_atual lexbuf)}
| "while"  { ENQUANTO (pos_atual lexbuf)}
| "then"     { ENTAO (pos_atual lexbuf)}
| "escolha"   { ESCOLHA (pos_atual lexbuf)}
| "print"   { ESCREVA (pos_atual lexbuf)}
| "do"      { FACA (pos_atual lexbuf)}
